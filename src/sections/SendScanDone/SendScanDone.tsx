    ...
    <section className="flex overflow-hidden flex-col gap-5 justify-center items-center w-full border-t padding-t max-sm:padding-x padding-b max-container bg-background-main border-slate-300">
      <div className="flex flex-col gap-2 items-center mt-7 sm:mt-5">
        <motion.h1
          ...
          viewport={{ once: false }}
          className="sm:text-[72px] text-[36px] tracking-text font-calsans text-[#2e1109]"
        >
          Send. Scan. Done.
        </motion.h1>
        <motion.p
          ...
          viewport={{ once: false }}
          className="info-text text-[#742B17]"
        >
          Obverse turns your Telegram into a powerful payment tool. No apps. No wallets to build. Just one command.
        </motion.p>
      </div>
