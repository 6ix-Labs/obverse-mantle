...
function WalletConnect() {
  ...
  const isSolanaNetwork = isSolanaConnected || chain?.name?.toLowerCase().includes("solana");
  ...
  return (
    <div>
      {isConnected ? (
        <div className="flex flex-col items-center space-y-4 lg:flex-row lg:space-y-0 lg:space-x-3">
          <WalletSheet />
